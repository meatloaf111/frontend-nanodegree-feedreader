...
$(function() {
    ...
    */
    ...
    describe('The menu', function(){
        ...
        /* It tests that ensures the menu element is
        ...
        it('menu element is hidden by default', function() {
         ...
         /* It tests that ensures the menu changes
          * visibility when the menu icon is clicked. This test
          * should have two expectations: does the menu display when
          * clicked and does it hide when clicked again.
          */
         it('menu changes when the menu icon is clicked', function(){
    ...
    describe('Initial Entries', function(){
        ...
        /* It tests that ensures when the loadFeed
    ...
    /* A new test suite named "New Feed Selection" */
        ...
        /* It tests that ensures when a new feed is loaded
